...
"../Rotor/DTU_10MW_AeroDyn.dat"				AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"Control/DTU_10MW_OO_GoM_ServoDyn.dat" 		ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"DTU_10MW_OO_GoM_HydroDyn.dat"    			HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      								SubFile         - Name of file containing sub-structural input parameters (quoted string)
"../Mooring/DTU_10MW_OO_GoM_MoorDyn.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
